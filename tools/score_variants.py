...
def global_vars():
	global tool_dir, prog_dir, ucsc_dir, ucsc_exe, ucsc_web, prog_dat, verbose, canfam2, canfam3, hg38, biofold
	verbose = False
	...
	ucsc = 'http://hgdownload.cse.ucsc.edu/goldenPath'
		...
		'canfam2.phyloP4way.bw':biofold+'/canfam2','canfam2.phyloP10way.bw':biofold+'/canfam2',\
		'canfam3.phyloP4way.bw':biofold+'/canfam3','canfam3.phyloP10way.bw':biofold+'/canfam3',\
	...
	canfam2['phylop']=['canfam2.phyloP4way.bw','canfam2.phyloP10way.bw', \
			'canfam2.phyloP10way.bw']
	canfam2['coding']='canfam2_coding.bed'
	canfam3={}
	canfam3['fasta']='canfam3.2bit'
	canfam3['phylop']=['canfam3.phyloP4way.bw','canfam3.phyloP10way.bw', \
...
def parse_variants(ichr,pos,wt,nw,ucsc_exe,ucsc_dbs,web=False,dbfasta='canfam2.2bit',fprog='twoBitToFa',wseq=100):
	ipos=pos-1
	n_pos=pos
	n_wt=''
	n_nw=''
...
def get_sequence(ichr,ipos,ucsc_exe,ucsc_dbs,web=False,win=2,dbname='canfam2.2bit',prog='twoBitToFa'):
	nuc=''
	seq=''
	s=max(0,ipos-win)
	e=ipos+win+1
...
def get_conservation(ichr,ipos,ucsc_exe,ucsc_dbs,web=False,win=2,dbname='canfam2.phyloP4way.bw',prog='bigWigToBedGrpah'):
	s=max(0,ipos-win)
        e=ipos+win+1
	v=[]
	for i in range(s,e):
...
def get_fconservation(ichr,ipos,ucsc_exe,ucsc_dbs,web=False,win=2,dbname='canfam2.phyloP4way.bw',prog='bigWigToBedGraph'):
	s=max(0,ipos-win)
	e=ipos+win+1
...
def get_phdsnp_input(ichr,ipos,wt,nw,ucsc_exe,ucsc_dbs,web=False,win=2,dbfasta='canfam2.2bit',dbpps=['canfam2.phyloP4way.bw','canfam2.phyloP10way.bw'],pklcod='canfam2_coding.pkl',fprog='twoBitToFa',cprog='bigWigToBedGraph'):
...
def get_snv_input(ichr,ipos,wt,nw,ucsc_exe,ucsc_dbs,web=False,win=2,dbfasta='canfam2.2bit',dbpps=['canfam2.phyloP4way.bw','canfam2.phyloP10way.bw'],pklcod='canfam2_coding.pkl',fprog='twoBitToFa',cprog='bigWigToBedGraph'):
	# for 0 starting genome
	nuc=''
	seq=''
	seq_input=[]
...
def get_indel_input(ichr,ipos,wt,nw,ucsc_exe,ucsc_dbs,web=False,win=2,dbfasta='canfam2.2bit',dbpps=['canfam2.phyloP4way.bw','canfam2.phyloP10way.bw'],pklcod='canfam2_coding.pkl',fprog='twoBitToFa',cprog='bigWigToBedGraph'):
	# for 0 starting genome        
	nuc=''
	seq=''
	seq_input=[]
...
def get_file_input(namefile,ucsc_exe,ucsc_dbs,web=False,win=2,s='\t',dbfasta='canfam2.2bit',dbpps=['canfam2.phyloP4way.bw','canfam2.phyloP10way.bw'],pklcod='canfam2_coding.pkl',fprog='twoBitToFa',cprog='bigWigToBedGraph',vcf=False):
	vlines=[]
	f=open(namefile)
	p=range(4)
	if vcf: p=[0,1,3,4]
...
def get_options():
	...
	parser.add_option('-g','--genome', action='store', type='string', dest='hg', default='confam2', help='Genome version')
	...
	if hg=='canfam2':
		...
		#dbpps=canfam3['phylop']+canfam3['phastc']
